...
export default class Fixtures {
    ...
    public readonly infoResponse: string =
        `{
            "success": true,
            "results": [
                {
    ...
    public readonly accountsResponse: string =
        `{
            "success": true,
            "results": [
                {
    ...
    public readonly accountResponse: string =
        `{
            "success": true,
            "results": [
                {
    ...
    public readonly balanceResponse: string =
        `{
            "success": true,
            "results": [
                {
    ...
    public readonly transactionsResponse: string =
        `{
            "success": true,
            "results": [
                {
